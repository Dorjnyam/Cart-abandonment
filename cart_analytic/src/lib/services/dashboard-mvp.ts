...
const MOCK_OVERVIEW: DashboardOverview = {
  ...
  top_reason: {
    ...
    value: 0.74,
    explanation: "Mock data is enabled. Real mode shows empty state until Main API returns diagnoses.",
  },
  latest_recommendation: {
    id: 1,
    title: "Show final checkout cost earlier",
    summary: "Mock recommendation for frontend development only.",
    body: "Mock recommendation for frontend development only.",
    reason_code: "S5",
    reason_label: REASON_LABELS.S5,
    priority: "high",
    effort: "medium",
    expected_impact: "Reduce checkout abandonment.",
    evidence: ["Mock evidence"],
    action_steps: ["Mock action"],
    warning: "Mock data",
    source: "fallback",
    status: "new",
